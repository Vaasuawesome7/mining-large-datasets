...
util.second_pass(data.baskets, itemIndexTable, L1)

util.intermediate_pass_2_3()

print("\n------ SECOND ITEMSET ------")
L2 = util.third_pass(data.baskets, itemIndexTable, L1)
for item in L2.items():
    print(item)
    
print("\n------ THIRD ITEMSET ------")
L3 = util.fourth_pass(data.baskets, itemIndexTable, L2)
